...
const FileUploader = ({ onFileSelect }: FileUploaderProps) => {
    ...
    const { getRootProps, getInputProps, isDragActive, acceptedFiles } = useDropzone({ onDrop, multiple: false, accept: { 'application/pdf': ['.pdf'] }, maxFiles: 1, maxSize: 20 * 1024 * 1024 });
